...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="index.html" class="brand-logo">
							<img alt="Logo" src="{{ asset('employee/assets/media/logo/logo-light.png') }}" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
					...
					<!--end::Brand-->
					<!--begin::Aside Menu-->
					@include('customer_service.layout.sidebar')
					<!--end::Aside Menu-->
				</div>
				<!--end::Aside-->
				<!--begin::Wrapper-->
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ Auth::user()->employee_info->fname }}</span>
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{ Auth::user()->employee_info->fname[0] }}</span>
										</span>
									</div>
								</div>
								<!--end::User-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Exelpack Corporation</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
                        <img class="symbol-label" src="{{asset('employee/assets/media/users/default.jpg')}}" alt="">
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user()->employee_info->Fullname }}</a>
						<div class="text-muted mt-1">{{ Auth::user()->CheckAccount }}</div>
						<div class="navi mt-2">
                            ...
                            <a target="_blank" class="btn btn-light-danger font-weight-bold" href="{{ route('destroy') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                {{ __('Sign Out') }}
                            </a>
		...
		<script src="{{ asset('employee/assets/js/pages/widgets.js') }}"></script>
		...
		<script src="{{ asset('employee/assets/js/pages/features/calendar/basic.js') }}"></script>
        <script src="{{ asset('employee/js/main.js') }}" type="module"></script>
